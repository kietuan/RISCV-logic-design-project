...
#
# Script generated by Vivado on Wed Sep 27 17:10:33 +0700 2023
...
#
# Usage        : processor.sh
#                processor.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                processor.sh [-reset_run]
#                processor.sh [-reset_log]
#                processor.sh [-help]
#
...
#                script (type 'processor.sh -help' for more information).
#
...
# script info
echo -e "processor.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./processor.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../../project_2.gen/sources_1/bd/processor/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../project_2.gen/sources_1/bd/processor/ipshared/aed8/hdl" +incdir+"../../../../project_2.gen/sources_1/bd/processor/ipshared/ec67/hdl" +incdir+"../../../../project_2.gen/sources_1/bd/processor/ipshared/aed8/hdl" +incdir+"C:/Users/tuankiet/App/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.processor xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.processor -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log processor_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: processor.sh [-step]\n\
Usage: processor.sh [-lib_map_path]\n\
Usage: processor.sh [-reset_run]\n\
Usage: processor.sh [-reset_log]\n\
Usage: processor.sh [-keep_index]\n\
